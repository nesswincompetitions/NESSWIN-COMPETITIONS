export default function Badge({ children, variant = "hot" }) {
  const variants = {
    ...
    warning: "bg-amber-600/35 text-white border-amber-500/50 shadow-[0_0_12px_rgba(245,158,11,0.3)]",
    neutral: "bg-gray-600/40 text-gray-100 border-gray-500/50",
    danger: "bg-red-600/35 text-white border-red-500/50 shadow-[0_0_12px_rgba(220,38,38,0.3)]",
